export const COMPANIES = [
  ...
  },
  {
    ...
    keyMetrics: {
      ebitda: 4.2, adjustedEbitda: 4.85, ebitdaMargin: 8.0, adjustedEbitdaMargin: 9.2,
    ...
    greenFlags: ["$68M backlog provides 15+ months of revenue visibility", "40% government contract mix provides payment certainty and counter-cyclical stability", "Experienced estimating team with <2% average cost overrun rate on completed projects", "Low leverage. Only $3.4M total debt on $4.85M adjusted EBITDA = 0.7x", "185 employees with low turnover (12% annually) in a tight labor market"],
    questions: [
      {
        q: "Ironclad's gross margin is 18% and EBITDA margin is 8%. How do these compare to commercial GC benchmarks, and what's the risk of margin erosion?",
      ...
      },
      {
        ...
        answer: "EBITDA bridge: Net Income $3.4M + Depreciation $0.8M + Interest $0.4M = EBITDA of $4.6M. Wait, that gives $4.6M but the reported EBITDA is $4.2M. The gap is likely because SGA includes some items that flow below EBITDA differently. Using the stated $4.2M EBITDA: Add-backs: $0.3M owner perks + $0.2M one-time legal + $0.15M above-market rent = $0.65M. Adjusted EBITDA = $4.2M + $0.65M = $4.85M. If you also normalize owner comp (replace $0.9M with a $250K GM), that adds another $650K, bringing normalized EBITDA to ~$5.5M or a 10.4% margin. For a GC business, that is strong.",
        type: "adjustment"
      },
      {
