...
export const SCENARIOS = [
    ...
    questions: [
      {
        ...
        answer: "Immediate impact: Revenue drops from $48.2M to ~$37.6M. But COGS is largely variable (food costs), so gross profit drops proportionally. The real pain is in SG&A, which is mostly fixed. Adjusted EBITDA collapses from $3.9M to ~$1.9M. Margin drops from 8.1% to 5.1%. At these margins, debt service becomes dangerous. Leverage goes from 1.5x to 3.2x. The business is no longer bankable. Key risks: (1) Other customers may follow if the competitor offers better pricing. (2) Supplier terms may tighten as volume drops. (3) Morale and retention of sales/delivery staff.",
      ...
      },
      {
        ...
        answer: "Post-loss adjusted EBITDA of $1.9M at a reduced multiple of 3-4x (distressed discount) = $5.7-7.6M. This is a roughly 60% decline in enterprise value from a 22% revenue loss. The multiple compression reflects: (1) Declining revenue trajectory scares buyers. (2) 5.1% margins leave zero room for error. (3) The customer loss proves concentration risk was real. A buyer might pay even less, demanding a sub-3x multiple for a turnaround situation. The business is now a distressed asset, not a PE platform.",
    ...
    questions: [
      {
        ...
        answer: "You could still invest, but the thesis changes completely. Without organic growth, the value creation plan shifts to: (1) Margin expansion through operational improvements (currently 12.1% adjusted, could push toward the mid-teens with better procurement and routing). (2) Add-on acquisitions of smaller HVAC shops to grow inorganically. (3) Increasing recurring service contract mix (currently 35%, push to 50%+). The risk is that without growth, you are buying a cash-flow business, not a growth story. The multiple should come down from ~6x for a healthy, growing HVAC business to 4.5-5x. At $3.4M adjusted EBITDA and 4.5x, TEV is ~$15.3M. Doable, but the returns depend entirely on execution, not tailwinds.",
  ...
  },
  {
    ...
    name: "Clinical Director Departure",
    description: "The lead clinical director announces retirement in 6 months. The business has no succession plan and 40% of patients specifically request him.",
    patches: {
      revenue: 8.3, // ~15% patient attrition from $9.8M
      context: "The lead clinical director is retiring in 6 months. No succession plan exists. He personally treats patients at 2 of the 5 locations and 40% of patients across the group specifically request him. The non-clinical founder/operator remains, but clinical leadership is gone.",
      incomeStatement: {
        revenue: [7.4, 8.3],
      ...
      redFlags: [
        ...
        "Leverage: $5.0M total debt on $1.4M adjusted EBITDA = 3.6x. Dangerous.",
        "Lead clinical director retiring with no succession plan",
    ...
    questions: [
      {
        type: "risk",
        q: "The lead clinical director is leaving in 6 months with no succession plan. 40% of patients specifically request him. What are the biggest risks and how would you mitigate them?",
      ...
      {
        type: "valuation",
        q: "Pre-departure, BrightSmile was valued at 8x adjusted EBITDA ($20M EV). How does the clinical director departure change the valuation, and what deal structure would you propose?",
